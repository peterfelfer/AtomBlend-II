...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, atom_coords, atom_color_list, props, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        """b
        ...
        if self.loaded_iter:
            self.gaussians.load_ply_ab(os.path.join(self.model_path, "point_cloud", "iteration_" + str(self.loaded_iter), "point_cloud.ply"), atom_coords, atom_color_list, props)
