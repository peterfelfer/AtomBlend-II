...
classes = (
    ...
    ATOMBLEND_PT_panel_general, ATOMBLEND_PT_panel_file, ATOMBLEND_PT_panel_rrng_file,
    ATOMBLEND_PT_shader_display_settings, ATOMBLEND_PT_render_picture, #ATOMBLEND_PT_rendering,  ATOMBLEND_PT_camera_settings, ATOMBLEND_PT_render_settings,
    # ATOMBLEND_PT_panel_dev
