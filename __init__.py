...
classes = (
    ...
    ATOMBLEND_PT_panel_file, ATOMBLEND_PT_shader_display_settings, ATOMBLEND_PT_scaling_cube, ATOMBLEND_PT_legend, ATOMBLEND_PT_rendering, ATOMBLEND_OT_preview,
